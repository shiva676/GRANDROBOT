...
TECHNO_IMG = "https://telegra.ph/file/1cea4733ae6a165511730.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Besthacker_xd")],
                                                                                   [InlineKeyboardButton(text="ADD DARK CRACKERS TEAM BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="http://t.me/DARKCRACKERSTEAMBOT")
                                                                                 ]]))
